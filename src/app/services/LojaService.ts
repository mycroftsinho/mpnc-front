...
export class LojaService {
    ...
    BuscarLojas(): Observable<any> {
        return this.http.get(this.accessPointUrlProd + '/Loja/ListarLojas',
        {
    ...
    BuscarLoja(lojaId: any): Observable<any> {
        return this.http.get(this.accessPointUrlProd + '/Loja/ObterLoja',
        {
            headers: new HttpHeaders({
                Authorization: 'Bearer ' + this.token,
                'Content-Type': 'application/json'
    ...
    AlterarLoja(data: any): Observable<any> {
        console.log(data);
        return this.http.post(this.accessPointUrlProd + '/Loja/CadastrarLoja', JSON.stringify(data),
        {
            headers: new HttpHeaders({
                Authorization: 'Bearer ' + this.token,
                'Content-Type': 'application/json'
    ...
    InativarLoja(data: any): Observable<any> {
        console.log(data);
        return this.http.post(this.accessPointUrlProd + '/Loja/Inativar', JSON.stringify(data),
        {
            headers: new HttpHeaders({
                Authorization: 'Bearer ' + this.token,
                'Content-Type': 'application/json'
